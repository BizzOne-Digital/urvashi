  ...
  for (const item of SHOP_PRODUCTS) {
    ...
    const payload = {
      ...
      shortDescription:
        ...
        `Order ${item.name.toLowerCase()} blank or customized with your artwork.`,

      longDescription:
        item.longDescription ||
        `Choose a blank ${item.name.toLowerCase()} or submit your design for a customized version. Design help is available for an additional fee.`,
