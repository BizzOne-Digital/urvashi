    ...
    return (
      <section className="py-20">
        <Container className="max-w-2xl text-center">
          <h1 className="heading-section text-pure-paper">Order confirmation</h1>
          <p className="mt-4 text-chrome-light">
            {orderNumber
              ? "We could not find this order link. It may have expired or the details are incorrect."
              : "Open this page from your checkout confirmation email, or complete a purchase to receive your order link."}
          </p>
