...
> = {
  ...
  "custom-tote-bags": { weightGrams: 180, lengthCm: 40, widthCm: 35, heightCm: 3 },
  caps: { weightGrams: 120, lengthCm: 22, widthCm: 22, heightCm: 12 },
  "custom-t-shirt-half-sleeve": { weightGrams: 200, lengthCm: 30, widthCm: 25, heightCm: 3 },
  "custom-t-shirt-full-sleeve": { weightGrams: 280, lengthCm: 32, widthCm: 26, heightCm: 3 },
  "custom-hoodies": { weightGrams: 550, lengthCm: 35, widthCm: 30, heightCm: 8 },
  "fridge-magnets": { weightGrams: 50, lengthCm: 10, widthCm: 10, heightCm: 1 },
};
