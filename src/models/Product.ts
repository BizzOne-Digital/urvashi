...
export interface IProduct extends Document {
  ...
  cardImage?: IMediaRef;
  /** Customize preview — front of garment/product */
  mockupFrontImage?: IMediaRef;
  /** Customize preview — back of garment/product */
  mockupBackImage?: IMediaRef;
...
const ProductSchema = new Schema<IProduct>(
  {
    ...
    mockupFrontImage: MediaRefSchema,
    mockupBackImage: MediaRefSchema,
