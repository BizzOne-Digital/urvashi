...
interface ProductMockupPreviewProps {
  ...
  /** When true, only show productName as the side title (no "Product preview" label). */
  sideLabelOnly?: boolean;
}
  ...
  return (
    <div className={cn("min-w-0", className)}>
      ...
      {productName && (
        <p
          className={cn(
            "font-display font-semibold text-pure-paper",
            sideLabelOnly ? "text-center text-2xl" : "mt-2 text-lg"
          )}
        >
          {productName}
        </p>
